...
class DisableInitialization(ReplaceHelper):
    ...
    def __enter__(self):
        ...
        def transformers_utils_hub_get_file_from_cache(original, url, *args, **kwargs):
            ...
            if url == f'https://huggingface.co/openai/clip-vit-large-patch14/resolve/main/added_tokens.json' or url == 'openai/clip-vit-large-patch14' and args[0] == 'added_tokens.json':
                return None
